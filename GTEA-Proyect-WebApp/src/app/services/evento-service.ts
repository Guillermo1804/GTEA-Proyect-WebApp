...
export class EventoService {
   ...
   * Endpoint esperado: GET /lista-eventos/
   */
  public obtenerEventos(): Observable<Evento[]> {
    ...
    return this.http.get<any[]>(`${environment.url_api}/lista-eventos/`, { headers }).pipe(
   ...
   * Endpoint esperado: GET /evento/?id={id}
   */
  public getEventoByID(idEvento: number): Observable<Evento | null> {
    ...
    return this.http.get<any>(`${environment.url_api}/evento/?id=${idEvento}`, { headers }).pipe(
  ...
  public editarEvento(idEvento: number, data: Evento): Observable<any> {
    ...
    return this.http.put<any>(`${environment.url_api}/eventos-edit/`, { ...data, id: idEvento }, { headers });
  }
   ...
   * Endpoint esperado: GET /lista-categorias/
   */
  public obtenerCategorias(): Observable<any[]> {
    ...
    return this.http.get<any[]>(`${environment.url_api}/lista-categorias/`, { headers });
  }

  /**
   * [READ] Obtener sedes disponibles para el select del Paso 2
   * Endpoint esperado: GET /lista-sedes/
   */
  public obtenerSedes(): Observable<any[]> {
    ...
    return this.http.get<any[]>(`${environment.url_api}/lista-sedes/`, { headers });
  }

  /**
   * [READ] Obtener aulas filtradas por sede
   * Endpoint esperado: GET /lista-aulas/?sede_id={sedeId}
   */
  public obtenerAulasPorSede(sedeId: string | number): Observable<any[]> {
    ...
    return this.http.get<any[]>(`${environment.url_api}/lista-aulas/?sede_id=${sedeId}`, { headers });
  }
